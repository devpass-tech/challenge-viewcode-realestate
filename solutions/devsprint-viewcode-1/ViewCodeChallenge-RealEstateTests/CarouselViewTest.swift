...
//        carouselView.translatesAutoresizingMaskIntoConstraints = false
        ...
        do {
            ...
            assertSnapshot(matching: carouselView, as: Snapshotting.image(size: CGSize(width: 600, height: 200)), record: true)
//            assertSnapshot(matching: carouselView, as: Snapshotting.description, record: true)
        } catch {
            print(error)
        }
        
//        assertSnapshot(matching: carouselView, as: Snapshotting.image(size: CGSize(width: 200, height: 200)), record: true)
