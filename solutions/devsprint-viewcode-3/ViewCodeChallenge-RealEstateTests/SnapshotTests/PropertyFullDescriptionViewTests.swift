//
//  PropertyFullDescriptionViewTests.swift
//  ViewCodeChallenge-RealEstateTests
//
//  Created by Murillo R. Araújo on 14/12/21.
//
...
class PropertyFullDescriptionViewTests: XCTestCase {

   let snapshotSize = CGSize(width: 350, height: 600)

    func testPropertyFullDescriptionView() {
        ...
        assertSnapshot(matching: propertyFullDescriptionView, as: .image(size: snapshotSize))
    }
}
